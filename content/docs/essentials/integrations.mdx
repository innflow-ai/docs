...
Innflow integrates with dozens of external services. Depending on the service, an integration can use an OAuth connection, an API credential, or a connection managed by Innflow.

## Setting Up Integrations

<Steps>
  <Step title="Go to Credentials">
    Navigate to [Credentials](https://app.innflow.ai/credentials) from the sidebar.
  </Step>
  <Step title="Connect a service">
    Click **New Credential** and choose the service. OAuth integrations redirect you to authorize Innflow; API-based integrations ask for the required credential. Platform-managed integrations do not need a workspace credential.
  </Step>
...
- [Attio](/tools/crm-sales#attio) — CRM records, notes, tasks, and metadata
...
- [Web Scraper](/tools/search-data#web-scraper) — Focused URL and search-based page extraction

### Browser Automation
- [Browser Agent](/tools/browser-automation) — Run interactive, multi-step website tasks with Stagehand and Browserbase
...
### Forms
- [Typeform](/tools/forms#typeform) — Manage forms, responses, and insights
- [Google Forms](/tools/forms#google-forms) — Retrieve responses or trigger on submissions
- [Innflow Forms](/tools/forms#innflow-forms) — Publish a form backed by a workflow

### Social Publishing
- [LinkedIn](/tools/social-publishing#available-channels) — Posts and profile data
- [Meta](/tools/social-publishing#available-channels) — Facebook Page and Instagram publishing
- [X, Reddit, Bluesky, Threads, Telegram, Pinterest, and WhatsApp](/tools/social-publishing#available-channels) — Channel-specific publishing and messaging
...
- [Browser Agent](/tools/browser-automation) — Run interactive web tasks with Stagehand and Browserbase

## Authentication

OAuth integrations store tokens encrypted at rest and refresh them automatically when supported. Other integrations use encrypted API credentials or an Innflow-managed connection. To disconnect a workspace-owned service, remove it from the [Credentials](/features/credentials) page.
