...
<Steps>
  ...
  <Step title="Upload documents">
    Click **Upload** to add PDF, TXT, or Markdown files, or choose **Sync website** to convert a public webpage into a searchable source.
  </Step>
...
The node also supports **Upload** using a file URL, file name, and file type. Upload starts asynchronous document processing; it does not make the document immediately searchable.
...
- **Sync** a public HTTP or HTTPS website as Markdown content

Localhost and private-network website URLs are rejected.
