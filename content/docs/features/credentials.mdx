...
<Columns cols={3}>
  ...
  <Card title="Attio" icon="users">
    CRM records, notes, tasks, and metadata
  </Card>
  <Card title="Meta" icon="share-2">
    Facebook Page and Instagram publishing
  </Card>
  <Card title="X" icon="message-circle">
    X/Twitter publishing
  </Card>
</Columns>

Some integrations use API credentials instead of OAuth, such as Resend, Apollo, Ahrefs, Dub, PostHog, ElevenLabs, Typeform, Telegram, and custom HTTP endpoints. Platform-managed integrations such as Browser Agent do not require a workspace credential.
