...
The OpenRouter node is the general purpose LLM node. It provides access to more than 200 models through one node. Use it for summarization, classification, rewriting, extraction, drafting, and other prompt-based work.
