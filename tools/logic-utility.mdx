...
Create, rename, remove, and reshape fields for downstream nodes without writing code. Use Edit Fields to normalize an app response or prepare a clean object for a table, webhook, or integration action.
